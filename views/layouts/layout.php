        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                    <?php if(Yii::$app->user->isGuest): ?>
                        <div  >
                            <ul class="nav navbar-nav navbar-left">
                                <li><a class="blog-nav-item " href="<?php echo yii\helpers\Url::to(["user/reg"])?>">注册</a></li>
                                <li><a class="blog-nav-item " href="<?php echo yii\helpers\Url::to(["user/login"])?>">登录</a></li>
                            </ul>
                        </div>
                    <?php else: ?>
                        <div>
